...
// Using a Map object to store pending Promises (no longer needed with direct XHR handling)
// const pendingPromises = new Map(); // REMOVE THIS
...
async function initializePlugin() {
  window.plugin = {}; // Initialize the plugin object
  const thisPlugin = {
    id: pluginInfo.info.id,
    pluginId: pluginId,
    version: pluginInfo.info.version,
    queryPhoneInfo: queryPhoneInfo, // Now mostly a placeholder
  ...
  // Use callHandler to send pluginLoaded and pluginReady messages -- CORRECTED
